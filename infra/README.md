...
| `containerImage` | `mcr.microsoft.com/azuredocs/containerapps-helloworld:latest` | Initial placeholder image |
| `entraSpaClientId` | (from azd) | Entra app client ID |
| `aiFoundryAgentEndpoint` | (from azd) | AI Foundry endpoint URL |
| `aiFoundryAgentId` | (from azd) | Agent ID |
